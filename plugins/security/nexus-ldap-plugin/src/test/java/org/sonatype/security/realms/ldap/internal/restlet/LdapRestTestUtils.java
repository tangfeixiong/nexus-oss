...
public class LdapRestTestUtils
{
  ...
  public static void compare(LdapServerConfigurationDTO dto, LdapConfiguration ldapServer) {
    ...
    Assert.assertEquals(dto.getConnectionInfo().getCacheTimeout(), ldapServer.getConnection().getCacheTimeout());
    ...
    Assert.assertEquals(dto.getConnectionInfo().getRealm(), ldapServer.getConnection().getRealm());
