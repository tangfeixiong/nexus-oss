...
Ext.define('NX.view.header.Help', {
  ...
  tooltip: NX.app.PluginStrings.GLOBAL_HEADER_HELP_TOOLTIP,
  ...
  initComponent: function () {
    ...
    me.menu = [
      ...
      '-',
      {
        text: NX.app.PluginStrings.GLOBAL_HEADER_HELP_SUPPORT,
